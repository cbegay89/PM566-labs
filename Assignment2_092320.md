...
```
    ...
    ##    townname pm25_so4      bmi
    ## 1:   Alpine     1.73 15.33749
    ## 2:   Alpine     1.73 15.93183
    ## 3:   Alpine     1.73 19.38649
    ## 4:   Alpine     1.73 16.63283
    ## 5:   Alpine     1.73 15.75758
...
There are 1200 rows and 49 variables. There are no duplicates present
after the merge.
...
The minimum bmi is 11.30 and the maximum is 41.27. The majority of the
sample is in the normal range for bmi (n=886). There are 103
observations that are obese, 87 overweight, and 35 underweight.

\#3: Create Smoke\_gas\_exposure variable
...
```
    ...
    ## 
    ## Gas & Smoke Exposure    Gas Exposure Only          No Exposure 
    ##                  151                  739                  214 
    ##  Smoke Exposure Only 
    ##                   36
...
Four categories were created: No exposure, gas exposure only, smoke
exposure only, and gas & smoke exposure. There are 40 observations
missing from the smoke variable and 33 observations missing from the
gasstove variable.
...
```
    ...
    ## # A tibble: 12 x 4
    ##    townname      fev_avg asthma.indication prop_asthma
    ##    <chr>           <dbl>             <dbl>       <dbl>
    ##  1 Alpine          2087.             0.113     0.00925
    ##  2 Atascadero      2076.             0.255     0.0213 
    ##  3 Lake Elsinore   2039.             0.126     0.0101 
    ##  4 Lake Gregory    2085.             0.152     0.0127 
    ##  5 Lancaster       2003.             0.165     0.0135 
    ##  6 Lompoc          2034.             0.113     0.00925
    ##  7 Long Beach      1986.             0.135     0.0110 
    ##  8 Mira Loma       1985.             0.158     0.0127 
    ##  9 Riverside       1990.             0.11      0.00925
    ## 10 San Dimas       2027.             0.172     0.0144 
    ## 11 Santa Maria     2026.             0.134     0.0110 
    ## 12 Upland          2024.             0.121     0.0101
...
```
    ...
    ## # A tibble: 2 x 4
    ##   sex    fev_avg asthma.indication prop_asthma
    ##   <chr>    <dbl>             <dbl>       <dbl>
    ## 1 Female   1959.             0.121      0.0638
    ## 2 Male     2104.             0.173      0.0899
...
```
    ...
    ## # A tibble: 5 x 4
    ##   obesity_level2 fev_avg asthma.indication prop_asthma
    ##   <chr>            <dbl>             <dbl>       <dbl>
    ## 1 normal           1998.            0.141      0.113  
    ## 2 obese            2266.            0.21       0.0178 
    ## 3 overweight       2224.            0.165      0.0118 
    ## 4 underweight      1698.            0.0857     0.00251
    ## 5 <NA>             2018.            0.131      0.00925
...
```
    ...
    ## # A tibble: 5 x 4
    ##   smoke_gas_exposure   fev_avg asthma.indication prop_asthma
    ##   <chr>                  <dbl>             <dbl>       <dbl>
    ## 1 Gas & Smoke Exposure   2020.             0.130     0.0161 
    ## 2 Gas Exposure Only      2026.             0.148     0.0989 
    ## 3 No Exposure            2055.             0.148     0.0265 
    ## 4 Smoke Exposure Only    2056.             0.171     0.00503
    ## 5 <NA>                   2002.             0.149     0.00587

\#Looking at the data (EDA) EDA Checklist Week 3
...
```
    ...
    ##    iacid oacid total_acids       lon      lat     bmi2     fev2 pm25_mass2
    ## 1:  2.39  3.52         5.5 -116.7664 32.83505 15.33749 2529.276       8.74
    ## 2:  2.39  3.52         5.5 -116.7664 32.83505 15.93183 1737.793       8.74
    ## 3:  2.39  3.52         5.5 -116.7664 32.83505 19.38649 2121.711       8.74
    ## 4:  2.39  3.52         5.5 -116.7664 32.83505 16.63283 2466.791       8.74
    ## 5:  2.39  3.52         5.5 -116.7664 32.83505 15.75758 2251.505       8.74
    ## 6:  2.39  3.52         5.5 -116.7664 32.83505 15.29189 2188.716       8.74
    ##    obesity_level2  smoke_gas_exposure    sex
    ## 1:         normal         No Exposure Female
    ## 2:         normal                <NA> Female
    ## 3:         normal Smoke Exposure Only Female
    ## 4:         normal                <NA> Female
    ## 5:         normal         No Exposure   Male
    ## 6:         normal Smoke Exposure Only   Male
...
```
    ...
    ##    oacid total_acids       lon      lat     bmi2     fev2 pm25_mass2
    ## 1:   7.4       11.43 -117.6484 34.09751 14.11559 1691.275      22.46
    ## 2:   7.4       11.43 -117.6484 34.09751 16.46568 1733.338      22.46
    ## 3:   7.4       11.43 -117.6484 34.09751 20.70084 2034.177      22.46
    ## 4:   7.4       11.43 -117.6484 34.09751 14.28855 2077.703      22.46
    ## 5:   7.4       11.43 -117.6484 34.09751 18.02044 1929.866      22.46
    ## 6:   7.4       11.43 -117.6484 34.09751 18.05281 1945.743      22.46
    ##    obesity_level2 smoke_gas_exposure    sex
    ## 1:         normal        No Exposure Female
    ## 2:         normal        No Exposure Female
    ## 3:         normal  Gas Exposure Only   Male
    ## 4:         normal  Gas Exposure Only   Male
    ## 5:         normal  Gas Exposure Only Female
    ## 6:           <NA>        No Exposure Female
...
```
    ...
    ## Classes 'data.table' and 'data.frame':   1200 obs. of  55 variables:
    ...
    ##  $ bmi2              : num  15.3 15.9 19.4 16.6 15.8 ...
    ##  $ fev2              : num  2529 1738 2122 2467 2252 ...
    ##  $ pm25_mass2        : num  8.74 8.74 8.74 8.74 8.74 8.74 8.74 8.74 8.74 8.74 ...
    ##  $ obesity_level2    : chr  "normal" "normal" "normal" "normal" ...
    ##  $ smoke_gas_exposure: chr  "No Exposure" NA "Smoke Exposure Only" NA ...
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-9-2.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-9-3.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
Those with normal bmi are distributed throughout all fev values, with
the highest concentration in the 1800-2200 range. Those with lower bmi
are on the lower end of fev; alternatively, those who are overweight
have higher fev levels.
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
All categories of smoke/gas exposure seem to be evenly distributed among
all fev values. The highest concentration for all smoke/gas exposure
values hovers between 1800 and 2200.
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
5. A leaflet map showing the concentrations of PM2.5 mass in each of the
CHS communities.

There are higher pm 2.5 mass concentrations in the Los Angeles,
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-20-2.png)<!-- -->
...
![](Assignment2_092320_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->

1.  What is the association between BMI and FEV (forced expiratory
    volume)? Those who are overweight or obese tend to have higher FEV.
    There is little difference among those who are underweight and
    normal bmi levels.

2.  What is the association between smoke and gas exposure and FEV?
    Those who have gas exposure only have hight fev rates overall. Both
    gas and smoke exposure are distributed similarly. Those who have no
    exposure have fev exposure at all ranges.

3.  What is the association between PM2.5 exposure and FEV? There does
    not seem to be a association between pm2.5 exposure and FEV. The
    correlation line in the scatter plot is flat.
